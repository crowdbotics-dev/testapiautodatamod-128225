...
## Project Structure
    ...
    ├── testapiautodatamod_128225  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_128225`
...
2. Clone this repo and `cd testapiautodatamod_128225`
